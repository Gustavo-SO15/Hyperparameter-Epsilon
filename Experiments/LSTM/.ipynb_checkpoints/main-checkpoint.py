...
from Mod_MAdlr3 import Mod_MAdlr3
...
try:
    ...
    if args.optimizer.lower() == 'eadam':
        optimizer = EAdam(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2))
    if args.optimizer.lower() == 'adabelief':
        optimizer = AdaBelief2(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2))
    if args.optimizer.lower() == 'adammom':
        optimizer = AdamMom(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2))
    if args.optimizer.lower() == 'tadam':
        optimizer = TAdam(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2))
    if args.optimizer == 'adabelief_s':
        optimizer = AdaBelief2_S(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2)) 
    if args.optimizer == 'mod_madlr3':
        optimizer = Mod_MAdlr3(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2)) 
    if args.optimizer == 'madlr':
        optimizer = MAdlr(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2))  
    if args.optimizer == 'madlr_s':
        optimizer = MAdlr_S(params, lr=args.lr, weight_decay=args.wdecay,
                             eps=args.eps, betas=(args.beta1, args.beta2))    

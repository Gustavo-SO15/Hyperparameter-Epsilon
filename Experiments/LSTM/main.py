...
try:
    if args.cal_eps == True:
        ...
        if args.optimizer == 'adam':
            optimizer = Cal_eps_Adam(params, args.lr, betas=(args.beta1, args.beta2),
                          weight_decay=args.wdecay, num_batches=num_batches) 
        if args.optimizer == 'rmsprop':
            optimizer = Cal_eps_RMSprop(params, args.lr, alpha=args.beta2,
                          weight_decay=args.wdecay, num_batches=num_batches)     
        if args.optimizer == 'adabelief':
            optimizer = Cal_eps_AdaBelief(params, args.lr, betas=(args.beta1, args.beta2),
                          weight_decay=args.wdecay, num_batches=num_batches) 
        if args.optimizer == 'adammom':
            optimizer = Cal_eps_AdamMom(params, args.lr, betas=(args.beta1, args.beta2),
                          weight_decay=args.wdecay, num_batches=num_batches) 
    else:        
        #optimizer = None
        ...
        if args.optimizer == 'rmsprop':
            optimizer =  torch.optim.RMSprop(params, lr=args.lr, alpha=args.beta2, weight_decay=args.wdecay,
                                 eps=args.eps)  
        if args.optimizer == 'adabelief':

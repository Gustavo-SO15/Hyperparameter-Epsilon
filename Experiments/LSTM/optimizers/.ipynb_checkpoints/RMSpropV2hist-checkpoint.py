...
class RMSpropV2hist(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps_upper=0, eps_lower=1000,
        ...
        super(RMSpropV2hist, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(RMSpropV2hist, self).__setstate__(state)
        ...
        for group in self.param_groups:
            for kk, p in enumerate(group['params']):
               ...
               # print(state['step'])
                ...
                if (state['step']==686) : #or (state['step']%391==0): 

        ...
        for group in self.param_groups:
            for p in group['params']:
               ...
               ##     aux = 1
                ...
                aux = group['eps']*math.sqrt(state['step'])
                ...
                if amsgrad:
                    ...
                    denom = (max_exp_avg_var.add(group['eps']).sqrt() / math.sqrt(bias_correction2))
                else:
                    denom = (exp_avg_var.add(group['eps']).sqrt() / math.sqrt(bias_correction2))

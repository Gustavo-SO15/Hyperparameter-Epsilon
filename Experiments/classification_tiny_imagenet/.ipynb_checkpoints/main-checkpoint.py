...
def get_parser():
    ...
    parser.add_argument('--optim', default='sgd', type=str, help='optimizer', choices=['sgd', 'adam', 'adamw', 'adabelief', 'fastadabelief2', 'adabelief_s', 'adabelief_inf', 'diffgrad', 'adadelta', 'madlr', 'mod_madlr1', 'madlr_s', 'eadam', 'adammom', 'tadam', 'yogi', 'msvag', 'radam', 'fromage', 'adabound',])

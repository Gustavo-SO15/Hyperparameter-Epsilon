...
def get_parser():
    ...
    parser.add_argument('--optim', default='sgd', type=str, help='optimizer', choices=['sgd', 'adam','adamv2', 'adamw', 'adabelief','diffgrad', 'adadelta', 'madlr', 'yogi', 'msvag', 'radam', 'fromage', 'adabound',])

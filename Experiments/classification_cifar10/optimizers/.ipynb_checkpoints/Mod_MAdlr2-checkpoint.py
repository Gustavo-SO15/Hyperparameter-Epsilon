...
class Mod_MAdlr2(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(Mod_MAdlr2, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(Mod_MAdlr2, self).__setstate__(state)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                grad_residual = (torch.abs(exp_avg - grad) + torch.abs(grad))**2

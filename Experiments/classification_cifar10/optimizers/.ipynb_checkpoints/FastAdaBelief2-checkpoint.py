...
class FastAdaBelief2(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(FastAdaBelief2, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(FastAdaBelief2, self).__setstate__(state)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                aux_eps = group['eps']/state['step'] #####
                #aux_eps = group['eps'] #torch.clamp(exp_avg_var.mean(), max=1e-8)
                ...
                if amsgrad:
                    ...
                    denom = (max_exp_avg_var.add_(aux_eps) / math.sqrt(bias_correction2))
                else:
                    denom = (exp_avg_var.add_(aux_eps) / math.sqrt(bias_correction2))

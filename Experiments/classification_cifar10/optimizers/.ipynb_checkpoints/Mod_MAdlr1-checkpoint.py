...
class Mod_MAdlr1(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8,
        ...
        super(Mod_MAdlr1, self).__init__(params, defaults)
    ...
    def __setstate__(self, state):
        super(Mod_MAdlr1, self).__setstate__(state)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                grad_residual = (torch.abs(grad - exp_avg) + torch.abs(exp_avg))**2
                ...
                if amsgrad:
                 ...
                 #   denom = (max_exp_avg_var/bias_correction2+group['eps']/bias_correction3 ).sqrt().add_(group['eps'])
                else:
